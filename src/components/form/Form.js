...
{state.images.logo.croppedUrl&&<button onClick={(e) => dispatch({ type: 'clear-image', payload: { field: 'logo', value: { url: '', croppedUrl: '' } } })} className="crop-trigger">x</button>
}
            ...
            <div className="form-control">
                ...
                <div className="form-group">
                    ...
                    <div className="flex-center">
{state.images.image.croppedUrl&&<button onClick={(e) => dispatch({ type: 'clear-image', payload: { field: 'image', value: { url: '', croppedUrl: '' } } })} className="crop-trigger">x</button>
            ...
            <div className="form-control">
                ...
                <div className="form-group">
                    ...
                    <div className="flex-center">
{state.images.watermark.croppedUrl&&<button onClick={(e) => dispatch({ type: 'clear-image', payload: { field: 'watermark', value: { url: '', croppedUrl: '' } } })} className="crop-trigger">x</button>
}
